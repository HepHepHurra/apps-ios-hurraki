(function (window, undefined) {
        ...
        trigger: function (event, data, elem, onlyHandlers) {
            ...
            for (i = 0; i < eventPath.length && !event.isPropagationStopped(); i++) {
                ...
                if (handle && jQuery.acceptData(cur) &&
                    handle.apply && handle.apply(cur, data) === false) {
        ...
        .extend({
            ...
            off: function (types, selector, fn) {
                ...
                if (types && types.preventDefault && types.handleObj) {
                    ...
                    jQuery(types.delegateTarget).off(handleObj.namespace ? handleObj.origType + "." + handleObj
    ...
    jQuery.fn.extend({
        ...
        is: function (selector) {
            return !!selector && (typeof selector === "string" ? rneedsContext.test(selector) ? jQuery(selector, this.context).index(this[0]) >= 0 : jQuery.filter(selector, this).length >
    ...
    jQuery.extend({
        ...
        dir: function (elem, dir, until) {
            ...
            while (cur && cur.nodeType !== 9 && (until ===
                undefined || cur.nodeType !== 1 || !jQuery(cur).is(until))) {
                if (cur.nodeType === 1) {
                    matched.push(cur);
                }
                cur = cur[dir];
...
"</tbody></table>"],
    ...
    function getWidthOrHeight(elem, name, extra) {
        var val = name === "width" ? elem.offsetWidth : elem.offsetHeight,
            ...
            isBorderBox = jQuery.support.boxSizing && jQuery
        ...
        serializeArray: function () {
            return this.map(function () {
                ...
                return this.name && !this.disabled && (this.checked ||
                    rselectTextarea.test(this.nodeName) || rinput.test(this.type));
            }).map(function (i, elem) {
        ...
        ajax: function (url, options) {
            ...
            if (s.crossDomain == null) {
                ...
                s.crossDomain = !!(parts && (parts[1] !== ajaxLocParts[1] || parts[2] !==
                    ajaxLocParts[2] || (parts[3] || (parts[1] === "http:" ? 80 : 443)) != (ajaxLocParts[3] || (ajaxLocParts[1] === "http:" ? 80 : 443))));
            }
    ...
    return {
        ...
        loader: (function () {
            ...
            function execute(module) {
                var key, value, media, i, urls, cssHandle, checkCssHandles, cssHandlesRegistered = false;
                if (registry[module] === undefined) {
            ...
            return {
                ...
                work: function () {
                    var reqBase, splits, maxQueryLength, q, b, bSource, bGroup, bSourceGroup, source, group, g, i, modules, maxVersion, sourceLoadScript, currReqBase, currReqBaseLength, moduleMap, l, lastDotIndex, prefix, suffix, bytesAdded, async;
                    reqBase = {
...
/* cache key: db_3381_23_uvo:resourceloader:filter:minify-js:7:7c618479c13f1535d0029d46aa3464a6 */